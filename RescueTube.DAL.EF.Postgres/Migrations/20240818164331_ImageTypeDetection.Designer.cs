...
namespace RescueTube.DAL.EF.Postgres.Migrations
{
    ...
    [Migration("20240818164331_ImageTypeDetection")]
    partial class ImageTypeDetection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.AuthorArchivalSettings", b =>
                {
                    b.OwnsMany("RescueTube.Domain.DateTimeRange", "ArchiveVideosFromDateTimeRanges", b1 =>
                        {
                            b1.Property<Guid>("AuthorArchivalSettingsId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("AuthorArchivalSettingsId", "Id");

                            b1.ToTable("AuthorArchivalSettings");

                            b1.ToJson("ArchiveVideosFromDateTimeRanges");

                            b1.WithOwner()
                                .HasForeignKey("AuthorArchivalSettingsId");
                        });

                    b.Navigation("ArchiveVideosFromDateTimeRanges");
                });
