...
namespace RescueTube.DAL.EF.Postgres.Migrations
{
    ...
    [Migration("20251115234239_AddDataFetchSettings")]
    partial class AddDataFetchSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.Author", b =>
                {
                    ...
                    b.Property<Guid?>("ArchivalSettingsId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.AuthorArchivalSettings", b =>
                {
                    ...
                    b.Property<bool>("ArchivePlaylists")
                        .HasColumnType("boolean");

                    b.Property<bool>("ArchiveVideos")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsEnabledForArchival")
                        .HasColumnType("boolean");

                    b.HasKey("Id");

                    b.ToTable("AuthorArchivalSettings");
                });
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.AuthorImage", b =>
                {
                    ...
                    b.Property<short>("ImageTypeDetectionAttempts")
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ResolutionParseAttemptedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.PlaylistItemPositionHistory", b =>
                {
                    ...
                    b.ToTable("PlaylistItemPositionHistories");
                });
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.PlaylistStatisticSnapshot", b =>
                {
                    ...
                    b.ToTable("PlaylistStatisticSnapshot");
                });
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.Video", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ArchivalSettings", "RescueTube.Domain.Entities.Video.ArchivalSettings#VideoArchivalSettings", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<int>("DownloadPriority")
                                .HasColumnType("integer");

                            b1.Property<bool>("ShouldRegularlyFetchVideoData")
                                .HasColumnType("boolean");
                        });
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.Setting+Bool", b =>
                {
                    b.HasBaseType("RescueTube.Domain.Entities.Setting");
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.Setting+DataSize", b =>
                {
                    b.HasBaseType("RescueTube.Domain.Entities.Setting");

                    b.Property<long>("Value")
                        .HasColumnType("bigint")
                        .HasColumnName("DataSize_Value");
                    ...
                    b.HasDiscriminator().HasValue("DataSize");
                });

            modelBuilder.Entity("RescueTube.Domain.Entities.Setting+Long", b =>
                {
                    b.HasBaseType("RescueTube.Domain.Entities.Setting");
                    ...
                    b.HasDiscriminator().HasValue("Long");
                });

            modelBuilder.Entity("RescueTube.Domain.Entities.Setting+String", b =>
                {
                    b.HasBaseType("RescueTube.Domain.Entities.Setting");
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.Author", b =>
                {
                    b.HasOne("RescueTube.Domain.Entities.AuthorArchivalSettings", "ArchivalSettings")
                        .WithOne("Author")
                        .HasForeignKey("RescueTube.Domain.Entities.Author", "ArchivalSettingsId")
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.AuthorHistory", b =>
                {
                    b.HasOne("RescueTube.Domain.Entities.Author", "Current")
                        .WithMany("AuthorHistories")
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.JobSettings", b =>
                {
                    b.OwnsOne("RescueTube.Domain.Entities.DataFetchJobSettings", "DataFetchJobSettings", b1 =>
                        {
                            b1.Property<Guid>("JobSettingsId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.PlaylistItemPositionHistory", b =>
                {
                    b.HasOne("RescueTube.Domain.Entities.PlaylistItem", "PlaylistItem")
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.PlaylistStatisticSnapshot", b =>
                {
                    b.HasOne("RescueTube.Domain.Entities.Playlist", "Playlist")
                        .WithMany("PlaylistStatisticSnapshots")
                        .HasForeignKey("PlaylistId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("RescueTube.Domain.Entities.Playlist", b =>
                {
                    ...
                    b.Navigation("PlaylistStatisticSnapshots");
